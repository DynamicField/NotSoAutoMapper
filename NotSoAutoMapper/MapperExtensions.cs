...
namespace NotSoAutoMapper
{
    ...
    public static class MapperExtensions
    {
        ...
        public static IMapper<TInput, TResult> Merge<TInput, TResult>(this IMapper<TInput, TResult> mapper,
        ...
        /// <seealso cref="ExpressionExtensions.Merge{T}" />
        /// <seealso cref="IMapper{TInput,TResult}.WithExpression" />
        public static IMapper<TInput, TResult> MergeOriginal<TInput, TResult>(this IMapper<TInput, TResult> mapper,
            Expression<Func<TInput, TResult>> mergeExtension)
        {
            if (mapper is null)
            {
