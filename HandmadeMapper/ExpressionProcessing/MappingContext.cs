...
namespace HandmadeMapper.ExpressionProcessing
{
    ...
    public class MappingContext
    {
        ...
        /// <returns>
        ///     A new <see cref="MappingContext" /> whose <see cref="InputType" /> is the type of <typeparamref name="TInput" />
        ///     and
        ///     <see cref="ResultType" /> is the type of <typeparamref name="TResult" />
        /// </returns>
        public static MappingContext FromTypes<TInput, TResult>(IMapper<TInput, TResult>? mapper = null)
        {
            return new MappingContext(typeof(TInput), typeof(TResult), mapper);
        }
    }
}