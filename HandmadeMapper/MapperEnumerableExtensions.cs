...
namespace HandmadeMapper
{
    ...
    public static class MapperEnumerableExtensions
    {
        ...
        /// <typeparam name="TResult">The type of the elements in the projected result, and of the <paramref name="mapper"/>'s result type.</typeparam>
        /// <param name="source">A sequence of values to project.</param>
        /// <param name="mapper">The mapper to apply for each element.</param>
        /// <returns>An <see cref="IQueryable{T}"/> whose elements are the result of applying the <paramref name="mapper"/> on each element of source.</returns>
